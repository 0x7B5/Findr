...
class FindrCardOverlay: UIView {
  ...
  private func createLeftOverlay() {
    let leftTextView = FindrCardOverlayLabelView(withTitle: "NOPE",
                                                  color: .sampleRed,
  ...
  private func createUpOverlay() {
    let upTextView = FindrCardOverlayLabelView(withTitle: "LOVE",
                                                color: .sampleBlue,
  ...
  private func createRightOverlay() {
    let rightTextView = FindrCardOverlayLabelView(withTitle: "LIKE",
                                                   color: .sampleGreen,
                                                   rotation: -CGFloat.pi / 10)
...
private class FindrCardOverlayLabelView: UIView {
